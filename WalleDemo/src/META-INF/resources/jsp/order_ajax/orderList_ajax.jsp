...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btnNew").click(function() {
			parent.addTab("订单录入-ajax", "jsp/order_ajax/orderEdit_ajax.jsp", "icon icon-nav", true, true);
			var editTab = parent.getTab("订单录入-ajax");
		...
		$("#btnEdit").click(function() {
			...
			if (selected) {
				parent.addTab("订单录入-ajax", "jsp/order_ajax/orderEdit_ajax.jsp?orderNo=" + selected.logisticsOrderNo, "icon icon-nav", true, true);
				var editTab = parent.getTab("订单录入-ajax");
