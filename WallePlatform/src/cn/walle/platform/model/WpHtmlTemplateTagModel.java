...
/**
 * Model class for WpHtmlTemplateTag
 */
@Entity
@Table(name = "WP_HTML_TEMPLATE_TAG")
@DynamicInsert
@DynamicUpdate
public class WpHtmlTemplateTagModel extends BaseModelClass implements OperationLog {

	private static final long serialVersionUID = 1L;

	public static final String MODEL_NAME = "WpHtmlTemplateTag";
