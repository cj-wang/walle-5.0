...
/**
 * Model class for WpDynamicPage
 */
@Entity
@Table(name = "WP_DYNAMIC_PAGE")
@DynamicInsert
@DynamicUpdate
public class WpDynamicPageModel extends BaseModelClass implements OperationLog {

	private static final long serialVersionUID = 1L;

	public static final String MODEL_NAME = "WpDynamicPage";
