<%@page language='java' pageEncoding='utf-8'%>
	...
	<div  class='easyui-layout' fit="true" border="false">
		<!-- 查询条件form -->
		<div id='sysCodeTypeQueryDiv' region="north" border="true">
			<div class='datagrid-toolbar' border="false">
				<a id='queryBtn' class='easyui-linkbutton' iconCls='icon-search' >查询</a> 
				<a id='queryResetBtn' class='easyui-linkbutton' iconCls='icon-reload' >清空</a>
			</div>
			<form id="sysCodeTypeQueryForm" class='easyui-form' columns='3' i18nRoot="sysCodeTypeQueryFormSYS" border="false">
		...
		<!-- 系统代码类型grid -->
		<div id='sysCodeTypeDiv' region='west' title='系统代码类型' iconCls="icon-reload" style="width:500px;">
			 <div class="datagrid-toolbar" border="false">
			 ...
			 <table id='sysCodeTypeGrid' class='easyui-datagrid' queryType='WlSysCodeTypeModel' orderBy="codeTypeName"
			 		paramForm='sysCodeTypeQueryForm'
			 		singleSelect="true"  i18nRoot='sysCodeTypeGridSYS' border="false" fit="true" >
			 	<thead>
			 		<tr>
		...
		<!-- 系统代码grid-->
		<div id='sysCodeDiv' region='center' title='系统代码' iconCls="icon-reload">
			<div class="datagrid-toolbar" border="false">
			...
			<table  id='sysCodeGrid' class='easyui-datagrid'  queryType='WlSysCodeModel' orderBy="sort"
					singleSelect="true"  i18nRoot="sysCodeGridSYS" border="false" fit='true'>
				 <thead>
				 	<tr>
				 		<th field='codeName' ></th>
				 		<th field='codeValue' ></th>
				 		<th field='sort' ></th>
				 	</tr>
				 </thead>
			</table>
	...
	<!-- 弹出系统代码类型 新增/编辑 窗口 -->
	<div id='sysCodeTypeDialog' class="easyui-dialog" title='系统代码类型详细信息' iconCls='icon-edit' style="width:700px;" closed="true" modal="true">	
		<form id="sysCodeTypeForm" class='easyui-form' columns='2' i18nRoot='sysCodeTypeFormSYS' >
	...
	<!-- 弹出系统代码  新增/编辑 按钮 -->
	<div id="sysCodeDialog" class="easyui-dialog" title="系统代码详细信息" iconCls="icon-edit" style="width:700px;" closed="true" modal="true">
		<form id="sysCodeForm" class="easyui-form" columns="2" i18nRoot="sysCodeFormSYS">
